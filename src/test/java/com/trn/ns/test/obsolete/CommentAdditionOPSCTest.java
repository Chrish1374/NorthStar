...
//	public void test13_US1323_TC6856_TC6857_TC6864_US1331_TC6865_TC6958_TC6968_verifyOPAndCSAfterAddingComment() throws InterruptedException{
//
...
//
//		panel.assertFalse(panel.verifyResultsAreAccepted(1)&& panel.verifyResultsAreRejected(1), "Checkpoint[1/9]", "Verified that SC result is in Pending state.");
//		panel.enableFiltersInOutputPanel(true, true, true);
//		panel.assertEquals(panel.thumbnailList.size(), 2, "Checkpoint[2/9]", "Verified that SC result is in pending state in OP.");
//		panel.assertTrue(panel.getSliceComments(1).isEmpty(), "Checkpoint[3/9]", "Verified that slice lable is not visible when no slice level comment added for SC result.");
...
//		panel.assertEquals(panel.getText(panel.commentInfo),ViewerPageConstants.ALREADY_FINDING, "Checkpoint[4/9]", "Verified tooltip when comment is already added for SC data");
//		panel.assertTrue(panel.verifyResultsAreAccepted(1), "Checkpoint[5/9]", "Verified that SC result state change to accepted after adding comment ");
//
//		//verify clone in content selector after adding slice level comment for SC 
//		panel.assertTrue(contentSelector.verifyPresenceOfEyeIcon(ViewerPageConstants.CONTENT_SELECTOR_RESULT_PREFIX+username+"_1"), "Checkpoint[6/9]", "Verified clone in Content selector after adding slice level comment on SC data" );
//
...
//		panel.assertEquals(panel.thumbnailList.size(), 1, "Checkpoint[7/9]", "Verified that SC result in Output panel after adding comment from viewer under accepted tab.");
//		panel.assertEquals(panel.getCommentText(1), ViewerPageConstants.OUTPUT_PANEL_COMMENT_TEXT.trim(), "Checkpoint[8/9]", "Verified added comment in Output panel for SC result");
//		panel.assertEquals(panel.getCommentText(1), comment, "checkpoint[6.2/6]", "Verified added comment text in Output panel for SC result");
//		panel.assertEquals(panel.getSliceLabelText(1), ViewerPageConstants.OUTPUTPANEL_SLICE_LABEL+" "+panel.getCurrentScrollPositionOfViewbox(1), "checkpoint[6.2/6]", "Verified added comment text in Output panel for SC result");
//
//		panel.enableFiltersInOutputPanel(true, true, true);
//		panel.assertEquals(panel.thumbnailList.size(), 2, "Checkpoint[9/9]", "Verified that no new thumbnail created after adding comment to SC data");
//
//
//	}
//
//	@Test(groups = { "Chrome", "IE11", "Edge","Positive" ,"US1323","US1331","US1304"})
//	public void test14_US1323_TC6858_US1331_TC6924_TC6930_TC6932_US1304_TC7134_verifyLatestCommentCopyAfterAddingComment() throws InterruptedException, AWTException{
//
//		extentTest = ExtentManager.getTestInstance();
...
////		panel.enableFiltersInOutputPanel(true, false, false);
////		
////		panel.compareElementImage(protocolName, panel.sliceLevelComment,"Verifying alignment of slice comment and free text area at the bottom of comment text box","test14_Slice_Level_Comment");
//
//	
//	}
//
//	@Test(groups = { "Chrome", "IE11", "Edge","Negative" ,"US1323"})
//	public void test15_US1323_TC6860_TC6861_TC6862_TC6874_verifyTextAnnotationOnSCResultAndNavigationThroughSliceLevelComment() throws InterruptedException{
//
//		extentTest = ExtentManager.getTestInstance();
...
//	public void test16_US1323_TC6863_TC6866_verifyCommentWhenDICOMSCInRejected() throws InterruptedException{
//
//		extentTest = ExtentManager.getTestInstance();
...
////		panel.assertEquals(panel.getCommentText(1), ViewerPageConstants.OUTPUT_PANEL_COMMENT_TEXT.trim(), "checkpoint[6.1/6]", "Verified added comment text in Output panel for SC result");
//		panel.assertEquals(panel.getCommentText(1), comment, "checkpoint[6.2/6]", "Verified added comment text in Output panel for SC result");
//		panel.assertEquals(panel.getSliceLabelText(1), ViewerPageConstants.OUTPUTPANEL_SLICE_LABEL+" "+panel.getCurrentScrollPositionOfViewbox(1), "checkpoint[6.2/6]", "Verified added comment text in Output panel for SC result");
//
//	}
...
//
//	@Test(groups = { "Chrome", "IE11", "Edge","Positive" ,"US1331"})
//	public void test17_US1331_TC6925_TC6926_TC6960_TC6963_TC6947_verifySeriesLevelAddEditCommentForSCData() throws InterruptedException{
//
//		extentTest = ExtentManager.getTestInstance();
...
//		panel.assertEquals(panel.getCommentText(2), ViewerPageConstants.OUTPUT_PANEL_COMMENT_TEXT+comment, "checkpoint[5/6]", "Verified that series level comment in OP after reload of OP.");	
//
//		//edit series level comment and verify in OP
//		panel.editCommentFromOutputPanel(2, 5, comment+"_3", true);
//		panel.assertNotEquals(panel.getCommentText(2), ViewerPageConstants.OUTPUT_PANEL_COMMENT_TEXT+comment, "checkpoint[6/6]", "Verified that user can edit series level comment from OP for SC data");
//
//
//	}
//
//	@Test(groups = { "Chrome", "IE11", "Edge","Positive" ,"US1331"})
//	public void test18_US1331_TC6949_TC6953_TC6955_verifyEditingAndDeletionOfSliceLevelComment() throws InterruptedException{
//
//		extentTest = ExtentManager.getTestInstance();
...
//		panel.assertEquals(panel.getCommentText(1), editedComment, "checkpoint[4.2/7]", "Verified added comment text in Output panel for SC result");
//		panel.assertEquals(panel.getSliceLabelText(1), ViewerPageConstants.OUTPUTPANEL_SLICE_LABEL+" "+panel.getCurrentScrollPositionOfViewbox(1), "checkpoint[4.3/7]", "Verified added comment text in Output panel for SC result");
//
...
//		panel.deleteSliceComment(1,2, true);
...
//		panel.assertFalse(panel.getSliceComments(1).isEmpty(), "Checkpoint[6/7]", "Verified that slice lable is non-editable and not get deleted after deleting the comment");
//		panel.assertTrue(panel.getCommentText(1).isEmpty(), "checkpoint[6.1/7]", "Verified added comment text in Output panel for SC result");
//		panel.openAndCloseOutputPanel(false);
//
...
//	public void test19_US1331_TC6966_TC6976_verifySeriesAndSliceCommentForLatestCloneOfSC() throws InterruptedException{
//
//		extentTest = ExtentManager.getTestInstance();
...
//		panel.assertEquals(panel.getCommentText(2), comment, "checkpoint[3/5]", "Verified second series level comment in OP.");	
//		panel.assertEquals(panel.getCommentText(3),comment+"_3" , "checkpoint[4/5]", "Verified that edited series level comment is visible in OP .");	
//		panel.openAndCloseOutputPanel(false);
//
//		//verify SC result entry in finding menu
//		panel.openFindingTableOnBinarySelector(1);
//		panel.assertEquals(panel.getFindingsName(1, ViewerPageConstants.ACCEPTED_COLOR).get(0), scResultName, "Checkpoint[5/5]", "Verified that only one entry in finding menu for the SC data.");
//
//	}
//
//	@Test(groups = { "Chrome", "IE11", "Edge","Positive" ,"US1331"})
//	public void test20_US1331_TC6973_verifySCUnderMachineFilterOnOP() throws InterruptedException{
//
//		extentTest = ExtentManager.getTestInstance();
//		extentTest.setDescription("Desktop: Verify if Dicom SC result is showing under machine filter on output panel");
//
//		// Loading the patient on viewer
//		ExtentManager.customExtentReportLog(Configurations.INFO, extentTest, "", "Loading the Patient "+imbio_PatientName+" in viewer" );
//		patientPage = new PatientListPage(driver);
...
//		panel.addResultComment(1, comment);
//
//		//navigate to register page and create new user
...
//		registerUserPage.createNewUser(username1, "",username1 , LoginPageConstants.SUPPORT_EMAIL, username1, username1, username1);
//		Header header = new Header(driver);
//		header.logout();
//
//		//login with new user
//		loginPage.login(username1, username1);
...
//	
//		panel.waitForViewerpageToLoad(3);
//		//draw annotation on series
//		panel.inputImageNumber(116, 1);
//		circle=new CircleAnnotation(driver);
//		circle.selectCircleFromQuickToolbar(3);
//		circle.drawCircle(3, 70, 70, 80, 80);
//
//		panel.enableFiltersInOutputPanel(true, true, false);
//		panel.assertEquals(panel.getText(panel.machinesFilters.get(0)), machineName, "Checkpoint[1/3]", "Verified machine name in OP for SC result data.");
//		panel.assertEquals(panel.getText(panel.usersFiltersList.get(0)), username1, "Checkpoint[2/3]", "Verified user name in OP for SC result data.");
//
//	
//	}
//
//	@Test(groups = { "Chrome", "IE11", "Edge","Positive" ,"DE1862"})
//	public void test21_DE1862_TC7513_verifyDeletedCommentOnViewer() throws InterruptedException{
//
//		extentTest = ExtentManager.getTestInstance();
...
//		panel.assertEquals(panel.getCommentText(1)), seriesComment, "checkpoint[4/13]", "Verified added comment text in Output panel for SC result");
//		panel.assertEquals(panel.getSliceLabelText(1), ViewerPageConstants.OUTPUTPANEL_SLICE_LABEL+" "+imageNo, "checkpoint[5/13]", "Verified slice label text in Output panel for SC result");
//		panel.openAndCloseOutputPanel(false);
//
...
//		panel.enableFiltersInOutputPanel(false, false, true);
//		panel.assertTrue(panel.commentsForFindings.isEmpty(), "Checkpoint[9/13]", "Verified deleted series level comment in Output panel.");
//		panel.openAndCloseOutputPanel(false);
//
...
//		panel.assertNotEquals(panel.getCommentText(1)), seriesComment, "checkpoint[10/13]", "Verified in Output panel that no comment visible after creating text annotation.");
//		panel.assertEquals(panel.getText(panel.findingsNameList.get(0)),ViewerPageConstants.FINDING_NAME+": "+ ViewerPageConstants.TEXT_FINDING_NAME, "Checkpoint[11/13]", "Verified finding name for text annotation in Output panel.");
//		panel.openAndCloseOutputPanel(false);
//
...
//		panel.enableFiltersInOutputPanel(true, false, true);
//		panel.assertTrue(panel.findingsNameList.isEmpty(),"Checkpoint[13/13]", "Verified that text annotation thumbnail not visible in Output panel after deleting from Viewer.");
//		panel.openAndCloseOutputPanel(false);
//
//	}
//
...
//	public void test22_DE1779_TC7366_DE1889_TC7532_verifySeriesCommentAfterAddingCommentToAnnotation() throws InterruptedException{
//
//		extentTest = ExtentManager.getTestInstance();
...
//		panel.assertEquals(panel.getCommentText(1)), seriesComment, "checkpoint[4/10]", "Verified added comment text in Output panel for SC result");
//		panel.assertEquals(panel.getSliceLabelText(1), ViewerPageConstants.OUTPUTPANEL_SLICE_LABEL+" "+imageNo, "checkpoint[5/13]", "Verified slice label text in Output panel for SC result");
//		panel.openAndCloseOutputPanel(false);
//
//		//verify comment for SC on viewer page
//		panel.assertEquals(panel.getCommentText(1),seriesComment, "Checkpoint[6/10]", "Verified series level comment on viewer page.");
//		panel.click(panel.getViewPort(1));
//		panel.mouseHover(panel.getGSPSHoverContainer(1));
...
//		panel.assertEquals(panel.getCommentText(3), seriesComment, "checkpoint[9/10]", "Verified in Output panel that series level comment visible after creating text annotation as well.");
...
//
//	@Test(groups = { "Chrome", "IE11", "Edge","Positive" ,"DE1779","DE1889"})
//	public void test23_DE1779_TC7367_TC7387_DE1889_TC7532_verifyDICOMSCCommentAfterViewerReload() throws InterruptedException, AWTException{
//
//		extentTest = ExtentManager.getTestInstance();
...
//		panel.assertEquals(panel.getCommentText(1)), comment, "checkpoint[2/7]", "Verified added comment text in Output panel for SC result");
//
...
//		panel.assertEquals(panel.getCommentText(1)), editedComment, "checkpoint[5/7]", "Verified edited comment text in Output panel for SC result");
//		panel.openAndCloseOutputPanel(false);
//
//		contentSelector=new ContentSelector(driver);
...
//		panel.assertEquals(panel.getCommentText(1)), editedComment, "checkpoint[7/7]", "Verified edited comment text in Output panel for SC result");
//
//
//
//	}
//
//	@Test(groups = { "Chrome", "IE11", "Edge","Positive" ,"DE1779","DE1889"})
//	public void test24_DE1779_TC7388_DE1889_TC7532_verifyCommentWhenMultipleVersionOfDICOMSCLoadedOnViewer() throws InterruptedException, AWTException{
//
//		extentTest = ExtentManager.getTestInstance();
...
//		panel.assertEquals(panel.getCommentText(1)), seriesEditedComment, "checkpoint[2/8]", "Verified added comment text in Output panel for SC result");
//		panel.openAndCloseOutputPanel(false);
//
//		contentSelector.selectResultFromSeriesTab(1, ViewerPageConstants.CONTENT_SELECTOR_RESULT_PREFIX+username+"_1");
//		panel.enableFiltersInOutputPanel(true, false, false);
//		panel.assertEquals(panel.thumbnailList.size(), 1, "Checkpoint[3/8]", "Verified thumbnail for SC result under Accepted tab.");
//		panel.assertEquals(panel.getCommentText(1)), comment, "checkpoint[4/8]", "Verified added comment text in Output panel for SC result");
//		panel.openAndCloseOutputPanel(false);
//
...
//		panel.assertEquals(panel.getCommentText(1)), editedComment, "checkpoint[6/8]", "Verified added comment text in Output panel for SC result");
//		panel.openAndCloseOutputPanel(false);
//
...
//		panel.assertEquals(panel.getCommentText(1), seriesComment, "checkpoint[8/8]", "Verified added comment text in Output panel for SC result");
//		panel.openAndCloseOutputPanel(false);
//
//	}
//
//	@Test(groups = { "Chrome", "IE11", "Edge", "DE1911", "Positive"})
//	public void test25_DE1911_TC7626_verifyUserAbleToAddCommentForAnnotationAfterSliceLevelComment() throws InterruptedException{
//
//		extentTest = ExtentManager.getTestInstance();
...
//	public void test26_DE2006_TC8215_DR2107_TC8602_TC8603_verifySeriesCommentRetained() throws InterruptedException{
//
//		extentTest = ExtentManager.getTestInstance();
...
//		panel.enableFiltersInOutputPanel(false, false, true);
//		int thumbnail = panel.getThumbnailForGivenResult(scResultName);
//		panel.addCommentFromOutputPanelForSC(thumbnail+1,0, seriesComment);
//		panel.openAndCloseOutputPanel(false);
//
//		ExtentManager.customExtentReportLog(Configurations.INFO, extentTest, "", "Re-Open Output Panel  and verify comment section");
//		panel.enableFiltersInOutputPanel(false, false, true);
//		panel.assertEquals(panel.getCommentText(thumbnail+1),ViewerPageConstants.OUTPUT_PANEL_COMMENT_TEXT+seriesComment,"Checkpoint[1/5]","Added Comment \"Comment1\" should be shown  in output panel");
//		panel.openAndCloseOutputPanel(false);
//
...
//		panel.enableFiltersInOutputPanel(false, false, true);
//		panel.editCommentFromOutputPanelFoSC(thumbnail+1,seriesComment.length()+1,0,true, seriesEditedComment);
//		panel.openAndCloseOutputPanel(false);
//
//		ExtentManager.customExtentReportLog(Configurations.INFO, extentTest, "", "Re-Open Output Panel  and verify comment section");
//		panel.enableFiltersInOutputPanel(false, false, true);
//		panel.assertEquals(panel.getCommentText(thumbnail+1),ViewerPageConstants.OUTPUT_PANEL_COMMENT_TEXT+seriesComment+seriesEditedComment,"Checkpoint[2/5]","Updated Comment should be shown  in output panel on reopen");
//		panel.openAndCloseOutputPanel(false);
//
...
//		ExtentManager.customExtentReportLog(Configurations.INFO, extentTest, "", "Re-Open Output Panel  and verify comment section");
//		panel.enableFiltersInOutputPanel(false, false, true);
//		panel.assertEquals(panel.getCommentText(thumbnail+1),ViewerPageConstants.OUTPUT_PANEL_COMMENT_TEXT+seriesComment+seriesEditedComment,"Checkpoint[3/5]","Updated series Comment should be shown  in output panel on reload");
//		panel.openAndCloseOutputPanel(false);
//
...
//		panel.enableFiltersInOutputPanel(false, false, true);
//		panel.deleteCommentFromOutputPanel(thumbnail+1, true);
//		panel.openAndCloseOutputPanel(false);
//
//		ExtentManager.customExtentReportLog(Configurations.INFO, extentTest, "", "Re-Open Output Panel  and verify comment section");
//		panel.enableFiltersInOutputPanel(false, false, true);
//		panel.assertEquals(panel.getCommentText(thumbnail+1),ViewerPageConstants.OUTPUT_PANEL_COMMENT_TEXT.trim(),"Checkpoint[4/5]","Deleted comment should not be shown  in output panel on reopen");
//		panel.openAndCloseOutputPanel(false);
//
//		helper.browserBackAndReloadViewer(imbio_PatientName, 1, 3);
//		
//		ExtentManager.customExtentReportLog(Configurations.INFO, extentTest, "", "Re-Open Output Panel  and verify comment section");
//		panel.enableFiltersInOutputPanel(false, false, true);
//		panel.assertEquals(panel.getCommentText(thumbnail+1),ViewerPageConstants.OUTPUT_PANEL_COMMENT_TEXT.trim(),"Checkpoint[5/5]","Deleted comment should not be shown  in output panel on reload");
//		panel.openAndCloseOutputPanel(false);
//
//	}
//
//	@Test(groups = { "Chrome", "IE11", "Edge","Positive" ,"DE2006"})
//	public void test27_DE2006_TC8241_DR2107_TC8602_TC8603_verifySliceCommentRetained() throws InterruptedException{
//
//		extentTest = ExtentManager.getTestInstance();
...
//		panel.enableFiltersInOutputPanel(true, false, false);
//		panel.assertTrue(panel.verifySliceLabelAndCommentForSC(1, sliceLabel, comment), "Checkpoint[1/5]", "Verifying the Slice Label and comment for SC result");
//		panel.openAndCloseOutputPanel(false);
//
...
//		panel.enableFiltersInOutputPanel(true, false, false);
//		panel.editSliceCommentForSC(1, sliceLabel,true, editedComment);
//		panel.openAndCloseOutputPanel(false);
//
//		ExtentManager.customExtentReportLog(Configurations.INFO, extentTest, "", "Re-Open Output Panel  and verify slice comment section");
//		panel.enableFiltersInOutputPanel(true, false, false);
//		panel.assertTrue(panel.verifySliceLabelAndCommentForSC(1, sliceLabel, comment+editedComment), "Checkpoint[2/5]", "Verifying the Slice Label and comment for SC result is persisted on reopen of output panel");
//		panel.openAndCloseOutputPanel(false);
//		
//		helper=new HelperClass(driver);
//		helper.browserBackAndReloadViewer(imbio_PatientName, 1, 3);
...
//		ExtentManager.customExtentReportLog(Configurations.INFO, extentTest, "", "Re-Open Output Panel  and verify slice comment section");
//		panel.enableFiltersInOutputPanel(true, false, false);
//		panel.assertTrue(panel.verifySliceLabelAndCommentForSC(1, sliceLabel, comment+editedComment), "Checkpoint[3/5]", "Verifying the Slice Label and comment for SC result is persisted on reload");
//		panel.openAndCloseOutputPanel(false);
//		
//
...
//		panel.enableFiltersInOutputPanel(true, false, false);
//		panel.deleteSliceLabelCommentForSC(1,sliceLabel, true);
//		panel.openAndCloseOutputPanel(false);
//
//		ExtentManager.customExtentReportLog(Configurations.INFO, extentTest, "", "Re-Open Output Panel  and verify slice comment section");
//		panel.enableFiltersInOutputPanel(true, false, false);
...
//	public void test28_DE2127_TC8488_verifySCStateAfterUpdatingSliceLevelCommentFromOP() throws InterruptedException{
//
//		extentTest = ExtentManager.getTestInstance();
...
//		panel.assertTrue(panel.verifySliceLabelAndCommentForSC(1, sliceLabel, comment), "Checkpoint[2/5]", "Verifying the Slice Label and comment for SC result");
//		panel.openAndCloseOutputPanel(false);
//
...
//		panel.enableFiltersInOutputPanel(false, false, true);
//		panel.editSliceCommentForSC(2, sliceLabel,true, editedComment);
//		panel.openAndCloseOutputPanel(false);
//
...
//		panel.assertTrue(panel.verifySliceLabelAndCommentForSC(1, sliceLabel, comment+editedComment), "Checkpoint[4/5]", "Verifying the Slice Label and comment for SC result");
//		panel.openAndCloseOutputPanel(false);
//
//		panel.mouseHover(panel.getGSPSHoverContainer(1));	
...
//
//	@Test(groups = { "Chrome", "IE11", "Edge","Positive" ,"DE2127"})
//	public void test29_DE2127_TC8489_verifyUpdatedSliceCommentAfterReload() throws InterruptedException, AWTException{
//
//		extentTest = ExtentManager.getTestInstance();
...
//		panel.assertTrue(panel.verifySliceLabelAndCommentForSC(1, sliceLabel, comment), "Checkpoint[2/6]", "Verifying the Slice Label and comment for SC result");
//		panel.openAndCloseOutputPanel(false);
//
...
//		panel.assertTrue(panel.verifySliceLabelAndCommentForSC(1, sliceLabel, comment+editedComment), "Checkpoint[4/6]", "Verifying the Slice Label and comment for SC result");
//
//		helper=new HelperClass(driver);
//		helper.browserBackAndReloadViewer(imbio_PatientName, 1, 3);
//		panel.mouseHover(panel.getGSPSHoverContainer(1));
...
//
//	@Test(groups = { "Chrome", "IE11", "Edge","Positive" ,"DE2127"})
//	public void test30_DE2127_TC8490_verifySCStateAfterUpdatingSliceLevelCommentFromViewer() throws InterruptedException{
//
//		extentTest = ExtentManager.getTestInstance();
...
//		panel.assertTrue(panel.verifySliceLabelAndCommentForSC(1, sliceLabel, comment), "Checkpoint[2/8]", "Verifying the Slice Label and comment for SC result");
//		panel.openAndCloseOutputPanel(false);
//
...
//		panel.assertTrue(panel.verifySliceLabelAndCommentForSC(1, sliceLabel, editedComment), "Checkpoint[6/8]", "Verifying the Slice Label and comment for SC result");
//		panel.openAndCloseOutputPanel(false);
//
//		helper=new HelperClass(driver);
//		helper.browserBackAndReloadViewer(imbio_PatientName, 1, 3);
...
//	public void test31_DE2111_TC8613_verifySCStateForSeriesComment() throws InterruptedException{
//
//		extentTest = ExtentManager.getTestInstance();
...
//	
//		panel.enableFiltersInOutputPanel(true, false,false);
//		panel.assertTrue(panel.commentForFindings.isEmpty(),"Checkpoint[5/8]", "Verified that there are no findings in accepted state after editing a series level comment");
//		panel.openAndCloseOutputPanel(false);
//		
//		ExtentManager.customExtentReportLog(Configurations.INFO, extentTest, "", "Delete existing series level comment from output panel and hit enter ");
//		panel.mouseHover(panel.getViewPort(1));
...
//		
//		panel.enableFiltersInOutputPanel(true, false,false);
//		panel.assertTrue(panel.commentForFindings.isEmpty(), "Checkpoint[7/8]", "Verified that there are no findings in accepted state after deleting a series level comment");
//		panel.openAndCloseOutputPanel(false);
//		
//		ExtentManager.customExtentReportLog(Configurations.INFO, extentTest, "", "Re-Open Output Panel  and verify comment section");
//		panel.mouseHover(panel.getViewPort(1));
...
//	public void test32_DE2181_TC8719_verifySCStateForSeriesCommentWhenResultIsNotLoaded() throws InterruptedException, AWTException{
//
//		extentTest = ExtentManager.getTestInstance();
