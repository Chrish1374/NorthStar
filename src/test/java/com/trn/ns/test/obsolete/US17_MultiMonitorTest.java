...
//
////Protocol Execution Time (Required):  10 mins 
//
//public class US17_MultiMonitorTest extends TestBase{
//
...
//		dashboardPage.navigateToBaseURL();
...
//	}
//
//	// TC_35: Verify that user has to drag the windows to multiple monitors manually a very first time
//	
//	@Test(groups ={"Chrome"})
//	public void test01_TC35_verifyLaunchOfAppAndOpenNewChildWindows() throws InterruptedException {
//		
...
//	}
//	
//	//TC36	Verify that on close of single window instance leads to close all the instances of application
//	@Test(groups ={"Chrome"})
//	public void test02_TC36_verifyAppClosedOnAnyWindowClosure() throws InterruptedException{
//
//		extentTest = ExtentManager.getTestInstance();
...
//
//	
////	TC34	Verify that user is able to recover the same state as the user used the last time when the application was closed.
//	@Test(groups ={"Chrome"})
//	public void test03_TC34_verifyAppStateIsRecoveredOnReLaunch() throws InterruptedException{
//		extentTest = ExtentManager.getTestInstance();
...
//	}
//	
//	//TC41	Verify that window size is same as it was closed prior	
//	@Test(groups ={"Chrome"})
//	public void test04_TC41_verifyWindowsSizeAfterAppRecovery() throws InterruptedException{
//		extentTest = ExtentManager.getTestInstance();
