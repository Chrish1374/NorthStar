...
//		
//		String resultDescription = viewerPage.getResultDescriptionOverlayText(1);
...
//
//		List<String> rejectedFindings = findingMenu.getFindingsName(2,ViewerPageConstants.REJECTED_COLOR);
//		List<String> acceptedFindings = findingMenu.getFindingsName(2,ViewerPageConstants.ACCEPTED_COLOR);
//		List<String> pendingFindings = findingMenu.getFindingsName(2,ViewerPageConstants.PENDING_COLOR);
//
//		verifySRInOutputPanel(true, false, false,2,resultDescription,tooltipHeader,"test01_1");
//
...
//		viewerPage.assertEquals(panel.thumbnailList.size(), acceptedFindings.size(), "Checkpoint[5/7]", "verifying the Accepted finding name");
//	
...
//	public void test03_US1068_TC5383_verifyJumpToSRReportWhenReportIsnotLoaded() throws InterruptedException, AWTException{
//
//		extentTest = ExtentManager.getTestInstance();
...
//		viewerPage = new ViewerPage(driver);
//		viewerPage.waitForViewerpageToLoad(2);
//		viewerPage.closeBanner();
//		layout=new ViewerLayout(driver);
//
//		String seriesDesc = viewerPage.getResultDescriptionOverlayText(1);		
//
...
//		panel.clickOnJumpIcon(panel.getThumbnailForGivenResult(seriesDesc)+1);
//
//		viewerPage.assertNotEquals(viewerPage.getResultDescriptionOverlayText(1), changedSeriesDesc, "Checkpoint[2/10]", "Verifying the jump to icon functionality");		
//		viewerPage.assertEquals(viewerPage.getResultDescriptionOverlayText(1), seriesDesc, "Checkpoint[3/10]", "verifying the report is loaded in first viewbox post click on jump to icon");
//
...
//		panel.clickOnJumpIcon(panel.getThumbnailForGivenResult(seriesDesc)+1);
//
//		viewerPage.assertNotEquals(viewerPage.getResultDescriptionOverlayText(2), changedSeriesDesc, "Checkpoint[4/10]", "verifying the jump to icon when report is not loaded using double click");		
//		viewerPage.assertEquals(viewerPage.getResultDescriptionOverlayText(2), seriesDesc, "Checkpoint[5/10]", "verifying the report is loaded in first viewbox post jump to icon click");
//
//		layout.selectLayout(layout.twoByTwoLayoutIcon);
//		
//		viewerPage.assertEquals(viewerPage.getResultDescriptionOverlayText(1), seriesDesc, "Checkpoint[6/10]", "Verifying the series name using content selector post layout change");
//		viewerPage.assertEquals(viewerPage.getResultDescriptionOverlayText(2), seriesDesc, "Checkpoint[7/10]", "Verifying the series name using content selector post layout change");
//
...
//		panel.clickOnJumpIcon(panel.getThumbnailForGivenResult(seriesDesc)+1);
//
//		viewerPage.assertNotEquals(viewerPage.getResultDescriptionOverlayText(1), changedSeriesDesc, "Checkpoint[9/10]", "Verifying the jump to icon click functionality");		
//		viewerPage.assertEquals(viewerPage.getResultDescriptionOverlayText(1), seriesDesc, "Checkpoint[10/10]", "verifying the report is loaded in first viewbox on click of jump to icon");
//
//	}
//
...
//		viewerPage.click(viewerPage.getViewPort(2));
//
//		String resultDesc = viewerPage.getResultDescriptionOverlayText(1);	
...
//		panel.scrollIntoView(panel.srThumbnail);
//		panel.clickOnJumpIcon(panel.getThumbnailForGivenResult(resultDesc));
//
//		viewerPage.assertEquals(viewerPage.getResultDescriptionOverlayText(1), resultDesc, "Checkpoint[1/4]", "Verifying nothing has changed on viewbox 1");		
...
//		viewerPage.assertFalse(panel.verifyOutputPanelIsOpened(), "Checkpoint[4/4]", "Verifying that output panel is closed");
//
//
//	}
//
...
//		panel.clickOnJumpIcon(panel.getThumbnailForGivenResult(seriesDesc)+1);
//
//		viewerPage.assertNotEquals(viewerPage.getResultDescriptionOverlayText(1), changedSeriesDesc, "Checkpoint[2/7]", "Verifying the series desc has changed");		
//		viewerPage.assertEquals(viewerPage.getResultDescriptionOverlayText(1), seriesDesc, "Checkpoint[3/7]", "Verifying the result is loaded post jumptoicon click");
//
...
//		panel.clickOnJumpIcon(panel.getThumbnailForGivenResult(seriesDesc)+1);
//
//		viewerPage.assertNotEquals(viewerPage.getResultDescriptionOverlayText(1), changedSeriesDesc, "Checkpoint[4/7]", "Verifying the reult description is changed post layout changed to  1x2 ");
...
//		viewerPage.assertEquals(viewerPage.getResultDescriptionOverlayText(1), seriesDesc, "Checkpoint[6/7]", "Verifying the result is loaded post jumptoicon click");		
//		viewerPage.assertFalse(panel.verifyOutputPanelIsOpened(), "Checkpoint[7/7]", "verifying that output panel is closed");
//
//
//	}
//
...
//		panel.clickOnJumpIcon(panel.getThumbnailForGivenResult(seriesDesc)+1);
//
//		viewerPage.assertNotEquals(viewerPage.getResultDescriptionOverlayText(1), changedSeriesDesc, "Checkpoint[2/8]", "Verifying the series is unloaded");		
//		viewerPage.assertEquals(viewerPage.getResultDescriptionOverlayText(1), seriesDesc, "Checkpoint[3/8]", "Verifying the SR loading post Jump to icon");
...
//		findingMenu.rejectResult(1);
//
//		seriesDesc = viewerPage.getResultDescriptionOverlayText(1);		
//
//		contenSelector = new ContentSelector(driver);
//		contenSelector.selectSeriesFromSeriesTab(1, viewerPage.getSeriesDescriptionOverlayText(2));
//		viewerPage.click(viewerPage.getViewPort(1));
...
//		panel.clickOnJumpIcon(panel.getThumbnailForGivenResult(seriesDesc)+1);
//
//		viewerPage.assertNotEquals(viewerPage.getResultDescriptionOverlayText(1), changedSeriesDesc, "Checkpoint[6/8]", "Verifying the series is unloaded");		
//		viewerPage.assertEquals(viewerPage.getResultDescriptionOverlayText(1), seriesDesc, "Checkpoint[7/8]", "Verifying the SR loading post Jump to icon");
...
//		panel.clickOnJumpIcon(panel.getThumbnailForGivenResult(seriesDesc)+1);
//
//		viewerPage.assertNotEquals(viewerPage.getResultDescriptionOverlayText(1), changedSeriesDesc, "Checkpoint[2/12]", "Verifying series loaded using CS is unloaded");		
//		viewerPage.assertEquals(viewerPage.getResultDescriptionOverlayText(1), seriesDesc, "Checkpoint[3/12]", "verifying SR report is loaded post click on jump to icon");
//
...
//		viewerPage.click(viewerPage.bannerCloseIcon);
//
//		String changedSeriesDesc= viewerPage.getResultDescriptionOverlayText(1);
//		
//		viewerPage.click(viewerPage.getViewPort(2));
//	
//		DatabaseMethodsADB dba = new DatabaseMethodsADB(driver);
...
//		panel.enableFiltersInOutputPanel(false, false, true);
//		panel.scrollIntoView(panel.srThumbnail);
//		panel.clickOnJumpIcon(panel.getThumbnailForGivenResult(changedSeriesDesc));
//
//		viewerPage.assertEquals(viewerPage.getResultDescriptionOverlayText(1).trim(), changedSeriesDesc.trim(), "Checkpoint[1/3]", "Verifying the report is loaded on click of jump to icon");		
//	
//		List<String> thumbnailPayload = dba.getPayload(ActionLogConstant.USER_ACTION_THUMBNAIL_JUMP);
//
...
//		contentSelector.closingWarningAndWaterMark();
...
//		List<String> rejectedFindings = findingMenu.getFindingsName(1,ViewerPageConstants.REJECTED_COLOR);
...
//		verifyFindingsInOuputPanel(true, false, false, acceptedFindings,"Checkpoint[2/4]");
//		
//		viewerPage.click(viewerPage.getViewPort(2));
//		ExtentManager.customExtentReportLog(LogStatus.INFO, extentTest, "", "Verifying the rejected findings in output panel");
//		verifyFindingsInOuputPanel(false, true, false, rejectedFindings,"Checkpoint[3/4]");
//		
//		viewerPage.click(viewerPage.getViewPort(2));
//		ExtentManager.customExtentReportLog(LogStatus.INFO, extentTest, "", "Verifying the pending findings in output panel");
//		verifyFindingsInOuputPanel(false, false, true, pendingFindings,"Checkpoint[4/4]");
//
//
//	}
//	
...
//				
//		ExtentManager.customExtentReportLog(LogStatus.INFO, extentTest, "", "Retrieving the count from finding menu");
////		List<String> rejectedFindings = viewerPage.getFindingsName(1,ViewerPageConstants.REJECTED_COLOR);
////		List<String> acceptedFindings = viewerPage.getFindingsName(1,ViewerPageConstants.ACCEPTED_COLOR);
//		
////		poly.selectAcceptfromGSPSRadialMenu(poly.getLinesOfPolyLine(2, 1).get(0),true);	
////		List<String> pendingFindings = viewerPage.getFindingsName(2,ViewerPageConstants.PENDING_COLOR);		
//		
...
//		viewerPage.assertEquals(viewerPage.getText(panel.warningMessage).trim(),("\""+series+"\""+" "+ ViewerPageConstants.THUMBNAIL_WARNING_MSG).trim(), "Verify warning message if thumbnail corresponding slice is not open", "Verified warning message when thumbnail corresponding slice is not open in active view ");
//
//	}
//	
//	@Test(groups = { "Chrome", "IE11", "Edge","Positive" ,"US1086"})
...
//		panel.enableFiltersInOutputPanel(true, false, false);
//		
//		panel.assertEquals(panel.getMultiLineCommenEntriesInOP(1).get(0),comment1,"Checkpoint[2/5]","Verifying the comment1 is displayed in output panel");
//		
//		
//		poly.addResultComment(poly.getLinesOfPolyLine(1, 1).get(0), comment2);		
...
//		ExtentManager.customExtentReportLog(LogStatus.INFO, extentTest, "", "verifying the comment is displayed in output panel");
//		panel.enableFiltersInOutputPanel(true, false, false);		
//		panel.assertEquals(panel.getMultiLineCommenEntriesInOP(1).get(0),comment2,"Checkpoint[4/5]","Verifying the comment1 is displayed in output panel");
//		panel.assertEquals(panel.getMultiLineCommenEntriesInOP(2).get(0),comment1,"Checkpoint[5/5]","Verifying the comment2 is displayed in output panel");
//
//		
//	}
//	
//	@Test(groups ={"Chrome","Edge","IE11","US1084","US1086","US1502","Positive"})
//	public void test13_US1086_TC5538_US1502_TC8052_verifyCADSRResultEditingAndContentSelector() throws InterruptedException, SQLException, AWTException 
//	{
//		extentTest = ExtentManager.getTestInstance();
//		extentTest.setDescription("Verify output panel for CAD SR when original machine result is edited. <br>"+
//		"[Risk and Impact]: Verify that mammo CAD patient data is loaded properly.");
//	
//		// Loading the patient on viewer
//		patientListPage = new PatientListPage(driver);
//		patientListPage.clickOnPatientRow(IHEMammoTestPatientName);
...
//		ContentSelector contentSelector = new ContentSelector(driver);		
//		List<String> results = contentSelector.getAllResults();		
//		viewerPage.assertEquals(results.size(), 4, "Checkpoint[1/7]","Verify list of result seen in content selector");
//	
//		contentSelector.selectResultFromSeriesTab(1, results.get(results.size()-1),4);
//
//		poly.assertEquals(poly.getAllGSPSObjects(1).size(),3,"Checkpoint[2/7]","Verifying there are 3 GSPS objects present");		
//	//	contentSelector.assertTrue(contentSelector.validateGSPSResultIsSelectedOnContentSelector(1,results.get(results.size()-1),4), "Checkpoint[3/7]","verifying there are clones present post editing");
//		
//		panel = new OutputPanel_New(driver);
//		panel.enableFiltersInOutputPanel(false, false, true);		
//		
//		List<String> usersList = panel.getCreatorList();
//		
//		
//		for(int i =0;i<usersList.size();i++) {
//			panel.assertEquals(usersList.get(i).trim(), ViewerPageConstants.CREATED_BY_TEXT+" "+tooltipHeader, "Checkpoint[4/7]", "Verifying the created by username before editing");
//		}
//		panel.openAndCloseOutputPanel(false);
//		
//		point = new PointAnnotation(driver);		
...
//		
//		contentSelector.assertTrue(contentSelector.getAllResults().size()>results.size(), "Checkpoint[5/7]","verifying there are clones present post editing");		
//		//contentSelector.assertTrue(contentSelector.validateGSPSResultIsSelectedOnContentSelector(1,results.get(0)+"_"+username+"_1",4), "Checkpoint[6/7]","verifying there are clones present post editing");
//		
//		panel.enableFiltersInOutputPanel(true, false, true);		
//		
//		usersList = panel.getCreatorList();
//		for(int i =0;i<usersList.size();i++) {
//			panel.assertEquals(usersList.get(i).trim(), ViewerPageConstants.CREATED_BY_TEXT+" "+username, "Checkpoint[7/7]", "Verifying the created by username post editing");
//		}
//		panel.openAndCloseOutputPanel(false);
//		
//		
...
//	public void test14_US1086_TC5539_TC5540_verifyCADSRResultReplacedByOriginals() throws InterruptedException, SQLException, AWTException 
//	{
//		extentTest = ExtentManager.getTestInstance();
...
//	//	contentSelector.assertTrue(contentSelector.validateGSPSResultIsSelectedOnContentSelector(1,results.get(results.size()-1),4), "Checkpoint[3/11]","Verifying the last result is selected");
//				
//		
//		panel = new OutputPanel_New(driver);
//		panel.enableFiltersInOutputPanel(false, false, true);		
//		List<String> usersList = panel.getCreatorList();		
//		panel.assertEquals(panel.findingsList.size(),4, "Checkpoint[4/11]","verifying the outputpanel for findings");			
//		for(int i =0;i<usersList.size();i++) {
//			panel.assertEquals(usersList.get(i).trim(), ViewerPageConstants.CREATED_BY_TEXT+" "+tooltipHeader, "Checkpoint[5/11]", "Verifying the created by username before editing");
//		}
//		panel.openAndCloseOutputPanel(false);
//		
//		
...
//		usersList = panel.getCreatorList();
//		
//		panel.assertEquals(panel.findingsList.size(),4, "Checkpoint[7/11]","verifying the outputpanel for findings");		
//		for(int i =0;i<usersList.size();i++) {
//			panel.assertEquals(usersList.get(i).trim(), ViewerPageConstants.CREATED_BY_TEXT+" "+tooltipHeader, "Checkpoint[8/11]", "Verifying the created by username post selecting the original result");
//		}
//		panel.openAndCloseOutputPanel(false);
//		
//		//contentSelector.assertTrue(contentSelector.validateGSPSResultIsSelectedOnContentSelector(1,results.get(results.size()-1),4), "Checkpoint[9/11]","verifying the original result is selected in content selector");
//		
//		
...
//		
//		panel.enableFiltersInOutputPanel(true, false, true);		
//		panel.scrollIntoView(panel.createdByUserList.get(0));		
//		usersList = panel.getCreatorList();
//		panel.assertEquals(panel.findingsList.size(),4, "Checkpoint[10/11]","verifying the outputpanel for findings when original and clone are loaded in viewer");	
//		
//		for(int i =0;i<usersList.size();i++) {
//			panel.assertEquals(usersList.get(i).trim(), ViewerPageConstants.CREATED_BY_TEXT+" "+username, "Checkpoint[11/11]", "Verifying the created by username when original and clone are loaded in viewer");
//		}
//		panel.openAndCloseOutputPanel(false);
//		
//		
...
//	public void test15_DE1408_TC5714_verifyOPWhenSRLoadedInOneByOne() throws InterruptedException, AWTException{
//
//		extentTest = ExtentManager.getTestInstance();
...
//		ContentSelector contentSelector = new ContentSelector(driver);	
//
//		String resultDesc1 = viewerPage.getResultDescriptionOverlayText(1);	
//
...
//	public void test16_DE1345_TC5520_TC5664_verifyConsoleOnMouseHoverForSRAndNonDicom() throws InterruptedException 
//	{
//		extentTest = ExtentManager.getTestInstance();
...
//		viewerPage.assertFalse(viewerPage.isConsoleErrorPresent(), "Checkpoint[2/8]", "Verify no console error seen when mouse out on thumbnail for SR");
//
...
//		panel.mouseHover(panel.createdOnDateList.get(0));
//		viewerPage.assertFalse(viewerPage.isConsoleErrorPresent(), "Checkpoint[4/8]", "Verify no console error seen when mouse out on thumbnail for SC data");
//
...
//		panel.mouseHover(panel.createdOnDateList.get(1));
//		viewerPage.assertFalse(viewerPage.isConsoleErrorPresent(), "Checkpoint[6/8]", "Verify no console error seen when mouse out on thumbnail for PDF");
//	
...
//		panel.mouseHover(panel.createdOnDateList.get(0));
//		viewerPage.assertFalse(viewerPage.isConsoleErrorPresent(), "Checkpoint[8/8]", "Verify no console error seen when mouse out on thumbnail for Jpeg data");
//
//
//		
//	}
...
//	public void test17_DE1348_TC5541_verifyNoErrorWhileOpeningOutputPanelFrequently() throws InterruptedException{
//
//		extentTest = ExtentManager.getTestInstance();
...
//	
//	@Test(groups = { "Chrome", "IE11", "Edge","Positive" ,"DE1348"})
//	public void test18_DE1348_TC5615_verifyNoErrorOnRenderingSeriesFromContentSelector() throws InterruptedException, AWTException {
//
//		extentTest = ExtentManager.getTestInstance();
...
//	public void test19_DE1867_TC7498_verifyViewboxBorderWhenFindingSelectedFromOutputPanel() throws InterruptedException {
//
//		extentTest = ExtentManager.getTestInstance();
...
//		panel.assertFalse(panel.isElementPresent(panel.outputPanelSection), "Checkpoint[1/3]","Verified that Output panel closed after click on jump icon");
...
//	public void test20_DR2100_TC8494_verifyCommentAddedAfterViewerReload() throws InterruptedException, AWTException{
//
//		extentTest = ExtentManager.getTestInstance();
...
//		panel.enableFiltersInOutputPanel(true, false, false);
//		panel.assertEquals(panel.getText(panel.commentsForFindings.get(0)).replaceAll(ViewerPageConstants.OUTPUT_PANEL_COMMENT_TEXT, ""), comment, "Checkpoint[5/5]", "Verifying the comment for finding in Output panel is displayed after reload of viewer.");
//		
//	}
//	
...
//			viewerPage.assertEquals(panel.getText(panel.findingsNameList.get(i)).trim(),ViewerPageConstants.FINDING_NAME+": "+findings.get(i), checkpoint, "verifying finding name in output panel");
//		}
//		panel.openAndCloseOutputPanel(false);
//		
//	}
